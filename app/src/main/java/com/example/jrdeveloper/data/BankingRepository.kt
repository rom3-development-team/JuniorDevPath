...
import com.example.jrdeveloper.BankAccount
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.StateFlow

// class BankingRepository(private val bankingDatabase: BankingDatabase){
...
//    val bankingUiState: LiveData<BankingUiState> get() = _bankingUiState
    ...
    private var _bankingUiState: MutableStateFlow<BankingUiState> = MutableStateFlow(BankingUiState())
    val bankingUiState: StateFlow<BankingUiState> get() = _bankingUiState
